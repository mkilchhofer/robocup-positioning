...
public class HardwareMock {
    ...
    private void resetSocket() {
        ...
        try {
            ...
            LOGGER.trace("bufferedReader reset");

            connectionSocket.close();
            LOGGER.trace("connectionSocket reset");
    ...
    private void resetServerSocket() {
        ...
        try {
            ...
            serverSocket = null;
            LOGGER.error("Server socket reset.");
        }
    }
    ...
    private void analyseAndPerformAction(String stringToAnalyze){
        ...
        if (stringToAnalyze.contains("sEN LMDscandata 1")) {
            ...
            try {
                outputStream.write(DATA_START);
                outputStream.write(continuousMeasurementAnswer1.getBytes());
                outputStream.write(DATA_END);
                outputStream.flush();
            } catch (IOException e) {
            ...
            TimerTask task = new TimerTask() {
                ...
                public void run() {
                    ...
                    try {
                        outputStream.write(DATA_START);
                        outputStream.write(continuousMeasurementAnswer2.getBytes());
                        outputStream.write(DATA_END);
                        outputStream.flush();
                    } catch (IOException e) {
        ...
        if (stringToAnalyze.contains("sEN LMDscandata 0")) {
            ...
            try {
                outputStream.write(DATA_START);
                outputStream.write(continuousMeasurementAnswerStop.getBytes());
                outputStream.write(DATA_END);
                outputStream.flush();
            } catch (IOException e) {
    ...
    public static void main(String[] args) throws InterruptedException, UnknownHostException {
        new HardwareMock(2112, InetAddress.getByName("127.0.0.1"));
    }
}
